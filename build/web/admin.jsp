        ...
        <!-- Slider -->
            ...
            <div class="container">
                <div class="w3-bnr-inr-entry">
                    <h1 class="text-white">Administrator zalogowany</h1>
                </div>
            </div>
        </div>
        ...
        <div class="breadcrumb-row">
            <div class="container">
                <ul class="list-inline">
                    ...
                    <li>Administrator zalogowany</li>
                    
                    <div id="r"><font color="blue"><%= session.getAttribute("imie") %> <%= session.getAttribute("nazwisko") %></font> - ADMINISTRATOR</div> 
         ...
         <div class="section-full content-inner bg-white contact-style-1">
			<div class="container">
                <div class="row">
                        ...
                        <div class="alert alert-danger"> <strong><i class="fa fa-warning"></i>Uwaga!</strong> Administrator zalogowany.
