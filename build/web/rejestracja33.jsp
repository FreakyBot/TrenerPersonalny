         ...
         <div class="section-full content-inner bg-white contact-style-1">
			<div class="container">
                <div class="row">
                        ...
                        <div class="alert alert-danger"> <strong><i class="fa fa-warning"></i>Uwaga!</strong> Adres email <b> <%= session.getAttribute("email") %> </b> został już użyty do zalożenia konta w systemie.
                    ...
                    <div class="col-md-8">
                        <div class="p-a30 bg-gray clearfix m-b30 ">
							...
							<form action="rejestracja2" method="POST" onsubmit="return przetwarzajj_dane()">
						
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <div class="input-group">
                                                <label>Podaj adres email</label>   <input   class="form-control" type="text" name="email" placeholder="Adres email">
                                            </div>
                                        </div>
                                    </div>
