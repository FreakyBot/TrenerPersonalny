...
<li><a href="p_zapytania?id_user=<%= session.getAttribute("id_user") %>"> Prześlij pytanie<i class="fa fa-chevron-down"></i></a></li>                                
<li><a href="p_rezerwacje?id_user=<%= session.getAttribute("id_user") %>">Rezerwacja lekcji<i class="fa fa-chevron-down"></i></a></li>
 <li><a href="p_szukaj?id_user=<%= session.getAttribute("id_user") %>">Szukaj trenera<i class="fa fa-chevron-down"></i></a></li>
 <li><a href="p_zmiana?id_user=<%= session.getAttribute("id_user") %>">Zmiana hasła<i class="fa fa-chevron-down"></i></a></li> 
        ...
        <!-- Slider -->
            ...
            <div class="container">
                <div class="w3-bnr-inr-entry">
                    <h1 class="text-white">Użytkownik zalogowany</h1>
                </div>
            </div>
        </div>
        ...
        <div class="breadcrumb-row">
            <div class="container">
                <ul class="list-inline">
                    ...
                    <li>Użytkownik  zalogowany</li>
                    
                    <div id="r"><font color="blue"><%= session.getAttribute("imie") %> <%= session.getAttribute("nazwisko") %></font> - UŻYTKOWNIK</div> 
         ...
         <div class="section-full content-inner bg-white contact-style-1">
			<div class="container">
                <div class="row">
                        ...
                        <div class="alert alert-danger"> <strong><i class="fa fa-warning"></i>Uwaga!</strong> Użytkownik  zalogowany.
