         ...
         <div class="section-full content-inner bg-white contact-style-1">
			<div class="container">
                <div class="row">
                        ...
                        <div class="alert alert-danger"> <strong><i class="fa fa-warning"></i>Uwaga!</strong> Podany adres email nie został znaleziony w bazie danych.
                    ...
                    <div class="col-md-8">
                        <div class="p-a30 bg-gray clearfix m-b30 ">
							...
							<form action="logowanie" method="POST" onsubmit="return przetwarzajj_dane()">
