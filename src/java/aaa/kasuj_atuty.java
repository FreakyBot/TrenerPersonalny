 ...
 * @author aaaaa
 */
@WebServlet(name="kasuj_atuty", urlPatterns={"/kasuj_atuty"})
public class kasuj_atuty extends HttpServlet {
...
String id_atuty= request.getParameter("id_atuty");
        ...
        try
        {
         ...
         sql.executeUpdate("delete from atuty where id_atuty='"+id_atuty+"';");
