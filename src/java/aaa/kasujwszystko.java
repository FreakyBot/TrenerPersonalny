 ...
 * @author aaaaa
 */
@WebServlet(name="kasujwszystko", urlPatterns={"/kasujwszystko"})
public class kasujwszystko extends HttpServlet {
...
String id_grafik= request.getParameter("id_grafik");
        ...
        try
        {
         ...
         sql.executeUpdate("delete from rezerwacja where id_grafik='"+id_grafik+"' and id_trener='"+id_user+"';");
