 ...
 * @author aaaaa
 */
@WebServlet(name="a_zablokuj", urlPatterns={"/a_zablokuj"})
public class a_zablokuj extends HttpServlet {
...
String id_uu=request.getParameter("id_uu");
      ...
      sql=polaczenie.createStatement();
               ...
               sql.executeUpdate("update trener set  blokada=('1') where id_trener=('"+id_uu+"');");
