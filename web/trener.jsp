...
<li><a href="l_godziny?id_user=<%= session.getAttribute("id_user") %>"> Grafik<i class="fa fa-chevron-down"></i></a></li>                                
<li><a href="l_rezerwacje?id_user=<%= session.getAttribute("id_user") %>">Rezerwacje<i class="fa fa-chevron-down"></i></a></li>
  

<li><a href="l_zapytania?id_user=<%= session.getAttribute("id_user") %>"> Pytania<i class="fa fa-chevron-down"></i></a></li>
<li><a href="l_opinie?id_user=<%= session.getAttribute("id_user") %>"> Opinie<i class="fa fa-chevron-down"></i></a></li> 
<li><a href="l_zatrudnienie?id_user=<%= session.getAttribute("id_user") %>"> Siłownie<i class="fa fa-chevron-down"></i></a></li>


<li><a href="l_dane?id_user=<%= session.getAttribute("id_user") %>"> Mój profil<i class="fa fa-chevron-down"></i></a></li>  
<li><a href="l_zmiana?id_user=<%= session.getAttribute("id_user") %>">Zmiana hasła<i class="fa fa-chevron-down"></i></a></li> 
        ...
        <!-- Slider -->
            ...
            <div class="container">
                <div class="w3-bnr-inr-entry">
                    <h1 class="text-white">Trener zalogowany</h1>
                </div>
            </div>
        </div>
        ...
        <div class="breadcrumb-row">
            <div class="container">
                <ul class="list-inline">
                    ...
                    <li>Trener zalogowany</li>
                    
                    <div id="r"><font color="blue"><%= session.getAttribute("imie") %> <%= session.getAttribute("nazwisko") %></font> - TRENER</div> 
         ...
         <div class="section-full content-inner bg-white contact-style-1">
			<div class="container">
                <div class="row">
                        ...
                        <div class="alert alert-danger"> <strong><i class="fa fa-warning"></i>Uwaga!</strong> Trener zalogowany.
