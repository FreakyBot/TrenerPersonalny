...
{
	var dzSwitcher = '<div class=styleswitcher><div class=switcher-btn-bx><a class=switch-btn><span class="fa fa-gear fa-lg fa-spin"></span></a></div><div class=styleswitcher-inner><h6 class=switcher-title>Layout</h6><ul class=layout-view><li class="active wide-layout">Wide<li class=boxed>Boxed</ul><h6 class=switcher-title>Nav</h6><ul class=nav-view><li class="active nav-light">Light<li class=nav-dark>Dark<li class=nav-primary>Primary</ul><h6 class=switcher-title>Header</h6><ul class=header-view><li class="active header-fixed">Fixed<li class=header-static>Static</ul><h6 class=switcher-title>Color Skin</h6><ul class=color-skins><li><a class="theme-skin skin-1"href="@theme=css_2Fskin_2Fskin-1"title="default Theme"></a><li><a class="theme-skin skin-2"href="@theme=css_2Fskin_2Fskin-2"title="pink Theme"></a><li><a class="theme-skin skin-3"href="@theme=css_2Fskin_2Fskin-3"title="sky Theme"></a><li><a class="theme-skin skin-4"href="@theme=css_2Fskin_2Fskin-4"title="green Theme"></a><li><a class="theme-skin skin-5"href="@theme=css_2Fskin_2Fskin-5"title="red Theme"></a><li><a class="theme-skin skin-6"href="@theme=css_2Fskin_2Fskin-6"title="orange Theme"></a><li><a class="theme-skin skin-7"href="@theme=css_2Fskin_2Fskin-7"title="purple Theme"></a><li><a class="theme-skin skin-8"href="@theme=css_2Fskin_2Fskin-8"title="blue Theme"></a></ul><h6 class=switcher-title>Background Image</h6><ul class=background-switcher><li><img alt=""rel=images/background/bg1.jpg src=images/switcher/switcher-bg/bg1.jpg><li><img alt=""rel=images/background/bg2.jpg src=images/switcher/switcher-bg/bg2.jpg><li><img alt=""rel=images/background/bg3.jpg src=images/switcher/switcher-bg/bg3.jpg><li><img alt=""rel=images/background/bg4.jpg src=images/switcher/switcher-bg/bg4.jpg></ul><h6 class=switcher-title>Background Pattern</h6><ul class=pattern-switcher><li><img alt=""rel=images/pattern/pt1.jpg src=images/switcher/switcher-patterns/bg1.jpg><li><img alt=""rel=images/pattern/pt2.jpg src=images/switcher/switcher-patterns/bg2.jpg><li><img alt=""rel=images/pattern/pt3.jpg src=images/switcher/switcher-patterns/bg3.jpg><li><img alt=""rel=images/pattern/pt4.jpg src=images/switcher/switcher-patterns/bg4.jpg></ul></div></div>';
...
$(function(){		
	...
	jQuery('.nav-primary').on('click',function() { 
		jQuery(".header-nav").addClass('nav-primary')
		jQuery(".header-nav").removeClass('nav-light')
	});
	//=== Nav light & dark change function	END=====================//	
